...
var pokemonByName = "https://pokeapi.co/api/v2/pokemon/";
  ...
  // Uncomment this line to fade out the red box on page load
   ...
   var pokemon_1 = "Squirtle";

   var pokemon_2 = "Wartortle";

   var pokemon_3 = "Blastoise";
   ...
   $.getJSON(pokeapiUrl).done(function(data){
   	...
   	$.each(data.pokemon_species, function(index, pokemon)
      {
   		...
   		var name = pokemon_1.charAt(0).toUpperCase() + pokemon_1.slice(1);

   		var link = $("<a>").attr("id", pokemon_1).attr("href", "#").append($("<strong>").text(name));
